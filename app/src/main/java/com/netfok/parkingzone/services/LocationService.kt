package com.netfok.parkingzone.services
...
import com.netfok.parkingzone.ui.maps.MapsActivity

class LocationService : Service() {
    private val locationBinder by lazy { LocationBinder() }

    private val _location = MutableLiveData<com.netfok.parkingzone.model.Location>()
    val location: LiveData<com.netfok.parkingzone.model.Location?> = _location
    ...
    private val locationListener = object : LocationListener {
        override fun onLocationChanged(location: Location?) {
            val myLocation = location?.let { com.netfok.parkingzone.model.Location(it.latitude, it.longitude) }
    ...
    override fun onCreate() {
        ...
        _location.value = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER)?.run {
            com.netfok.parkingzone.model.Location(latitude, longitude)
        }
